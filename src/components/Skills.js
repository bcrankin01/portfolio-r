        ...
        <div className="skills-wrapper">
            ...
            <div className="row">
              <div className="col-md-12 header">
                ...
                <div className={`d-flex justify-content-center ${(selectedCard === 1) ? 'col-md-4'  : 'col-md-4'}`}>
                ...
                <div className={`d-flex justify-content-center ${(selectedCard === 2) ? 'col-md-4'  : 'col-md-4'}`}>      
                  <div className="card-div" onClick={() => handleClick(2)}>
                    <Card title="Back-End" backgroundImage="" icons={card2Icons} />
                  </div>
                </div>
                <div className={`d-flex justify-content-center ${(selectedCard === 3) ? 'col-md-4'  : 'col-md-4'}`}>      
